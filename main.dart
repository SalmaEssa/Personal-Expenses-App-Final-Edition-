...
return e.date.isAfter(DateTime.now().subtract(Duration(days: 7)));
    ...
    List<Widget> _build_portrait(MediaQueryData media_query,AppBar app_bar ){
      return [Container(
    ...
    List<Widget> _build_LandScape(MediaQueryData media_query,AppBar app_bar){
      return [
 ...
 AppBar build_AppBar(bool is_IOS){
   return 
    is_IOS?CupertinoNavigationBar(
  ...
  @override
  Widget build(BuildContext context) {
      final PreferredSizeWidget app_bar=build_AppBar(Platform.isIOS);
    ...
    final is_portrait=media_query.orientation==Orientation.portrait;
      final body=SingleChildScrollView(
        ...
        crossAxisAlignment: CrossAxisAlignment.stretch,
          children: <Widget>[
            if(!is_portrait)
             ..._build_LandScape(media_query, app_bar),
         if(is_portrait)
         ..._build_portrait(media_query,app_bar)
